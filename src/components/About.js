            ...
            <div className='About-s-2 gap-y-24'>
                <div className='flex gap-x-16'>
                    <Content
                        className="flex"
                        title="What We Do"
                        description="Our services are designed to deliver value and ensure customer satisfaction, focusing on innovative strategies and tailored solutions for every need."
                ...
                <div className='flex gap-x-16'>
                    ...
                    <Content
                        ...
                        description="We aim to create impactful results through our dedicated approach, ensuring every project meets the highest standards of quality and creativity."
                        descriptionClass="a-d-class"
                        name="Our Portfolio"
                        buttonClass="a-b-class"
                    />
